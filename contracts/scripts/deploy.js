 ...
 *   npx hardhat verify --network sepolia <DEPLOYED_ADDRESS> <OPERATOR_ADDRESS>
 *
...
async function main() {
  ...
  console.log(`Settlement : native ETH`);
  ...
  const vault = await PhantomVault.deploy(operator);
  ...
  console.log(`\nTo verify:`);
  console.log(
    `  npx hardhat verify --network sepolia ${address} ${operator}`
  );
